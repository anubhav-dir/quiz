...
/**
 * This is the model class for table "{{%quiz_correct_answer}}".
 *
 * @property int $id
...
class CorrectAnswer extends \app\components\MActiveRecord
{
    ...
    {
        return [
            [['question_id', 'answer', 'created_on', 'created_by_id', 'updated_on', 'updated_by_id'], 'required'],
