...
/**
 * This is the model class for table "{{%quiz_level}}".
 *
 * @property int $id
...
class Level extends \app\components\MActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['created_on', 'created_by_id', 'updated_on', 'updated_by_id', 'level'], 'required'],
